...
SessionStore.prototype.sync = deprecate.function(
	SessionStore.prototype.createDatabaseTable,
...
SessionStore.prototype.get = function(session_id, cb) {
	...
	this.connection.query(sql, params, function(error, rows) {
		...
		var session = !!rows[0] ? JSON.parse(rows[0][self.options.schema.columnNames.data]) : null;
